          ...
          {press.map((item) => (
            <StaggerItem key={item.url}>
              <a
                ...
                className="group grid grid-cols-[auto_1fr_auto] items-center gap-4 border-b border-[color:var(--color-sepia)]/25 py-6 transition-colors hover:bg-[color:var(--color-carta)] md:gap-8 md:py-7"
              >
                <span className="font-[family-name:var(--font-mono)] text-[0.7rem] uppercase tracking-[0.22em] text-[color:var(--color-sepia)]/55">
                ...
                <div>
                  ...
                  <p className="mt-1 font-[family-name:var(--font-cartel)] text-[0.7rem] uppercase tracking-[0.26em] text-[color:var(--color-sepia-soft)]">
                    {item.outlet}
                  </p>
                </div>
                <ArrowUpRight
