...
const POSTERS: Item[] = [
  {
    ...
    title: "Poor Piero",
    year: "2025",
    image: "/events/poor-piero/locandina.jpg",
    position: "center",
  },
  {
    slug: "no-shakespeare-fringe",
    title: "No Shakespeare · Fringe",
    year: "2024",
    image: "/events/no-shakespeare/locandina-fringe.jpg",
    position: "center",
  },
  {
    slug: "wander-fool-word",
    title: "Wander, Fool, Word",
    year: "2024",
    image: "/events/wander-fool-word/locandina.png",
    position: "center",
  },
  {
    slug: "viaggio-lingua",
    title: "Viaggio in lingua",
    year: "2024",
    image: "/events/viaggio-lingua/locandina.png",
    position: "center",
  },
  {
    slug: "no-shakespeare",
    title: "No Shakespeare",
    year: "2023",
    image: "/events/no-shakespeare/locandina.jpg",
    position: "center",
  },
];

type Mode = "stills" | "posters";
...
export function SelectedWork() {
  ...
  const items = mode === "stills" ? STILLS : POSTERS;
      ...
      <div className="container-site">
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div>
            ...
            <h2 className="mt-5 max-w-[26ch] font-[family-name:var(--font-inter)] text-[clamp(1.8rem,3.6vw+0.5rem,3.4rem)] font-light leading-[1.06] tracking-[-0.025em] text-[color:var(--color-sepia)]">
              {t("title")}
            </h2>
          </div>
        ...
        {/* Toggle — editorial, hairline underline */}
        <div
          role="tablist"
          aria-label={locale === "it" ? "Selezione" : "Selected work"}
        ...
        >
          ...
          />
          <span aria-hidden className="h-3 w-px bg-[color:var(--color-sepia)]/20" />
          <Toggle
            label={t("postersLabel")}
            active={mode === "posters"}
            ...
            >
              ...
              >
                ...
                >
                  <Image
                    src={item.image}
                    alt={mode === "posters" ? `${item.title}, locandina` : item.title}
                    fill
                    sizes="(min-width: 1024px) 28vw, (min-width: 640px) 58vw, 78vw"
                    className={`transition-transform duration-[1100ms] ease-[cubic-bezier(0.2,0.7,0.1,1)] group-hover:scale-[1.05] ${
                      mode === "posters" ? "object-cover" : "object-cover"
                    }`}
...
function Toggle({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`group relative font-[family-name:var(--font-inter)] text-[0.74rem] font-medium uppercase tracking-[0.26em] transition-colors duration-300 ${
        active
          ? "text-[color:var(--color-notte)]"
          : "text-[color:var(--color-muted)] hover:text-[color:var(--color-notte)]"
      }`}
    >
      <span className="relative inline-block pb-1.5">
        ...
        <span
          aria-hidden
          className={`absolute -bottom-px left-0 h-px w-full origin-left bg-[color:var(--color-ocra)] transition-transform duration-500 ease-[cubic-bezier(0.165,0.84,0.44,1)] ${
